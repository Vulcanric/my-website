...
const Hero = () => {
  ...
  return (
    <section id="home"
      className="h-screen w-full bg-[#0c1217] bg-right-top bg-[url('/3D-mobile1.png')] md:bg-[url('/3D-desktop.png')] bg-no-repeat bg-cover flex flex-col items-center justify-end gap-4 relative"
      style={{
    ...
    >
      <div className="size-fit absolute top-1/4 md:top-1/3 flex flex-col items-center">
        <h1 className="text-8xl md:text-9xl font-bold text-center text-slate-200 drop-shadow-xl">ERIC JOHN</h1>
        <br />
        <p className="w-fit px-5 text-2xl text-center text-slate-200 font-bold backdrop-blur-xl">SOFTWARE ENGINEER, FULLSTACK & WEB DEVELOPER</p>
        <br />
      ...
      <div
        className='border-2 border-white w-7 h-12 rounded-full hover:cursor-pointer flex flex-col items-center py-1 absolute bottom-[3rem]'
